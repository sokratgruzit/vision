<template>
  <div>
    ...
    <div class="roadmap-hepler__container">
      <transition-group name="fade-help" mode="out-in">
        <div class="roadmap-hepler" :key="0" v-if="help == 1">
        ...
        <div class="roadmap-hepler" :key="1" v-if="help == 2">
        <div class="roadmap-hepler__drag">
          <div class="roadmap-hepler__drag-line"></div>
